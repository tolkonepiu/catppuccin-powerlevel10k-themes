# Config file for Powerlevel10k with the style of robbyrussell (Catppuccin Macchiato) theme from Oh My Zsh.
#
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND='#a6da95'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND='#ed8796'
  # Prompt symbol: bold arrow.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_CONTENT_EXPANSION='%B➜ '

  # Cyan current directory.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#7dc4e4'
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=b8c0e0
