# Config file for Powerlevel10k with the style of robbyrussell (Catppuccin Latte) theme from Oh My Zsh.
#
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND='#40a02b'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND='#d20f39'
  # Prompt symbol: bold arrow.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_CONTENT_EXPANSION='%B➜ '

  # Cyan current directory.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#209fb5'
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=5c5f77
