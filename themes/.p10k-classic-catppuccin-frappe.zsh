# Config for Powerlevel10k with classic (Catppuccin Frappé) prompt style.
#
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#ca9ee6}'     # default foreground
      local      clean='%F{#ca9ee6}'   # green foreground
      local   modified='%F{#e5c890}'  # yellow foreground
      local  untracked='%F{#8caaee}'   # blue foreground
      local conflicted='%F{#e78284}'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%F{#949cbb}'  # grey foreground
      local      clean='%F{#949cbb}'  # grey foreground
      local   modified='%F{#949cbb}'  # grey foreground
      local  untracked='%F{#949cbb}'  # grey foreground
      local conflicted='%F{#949cbb}'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VCS_PREFIX='%F{#b5bfe2}on '
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%F{#b5bfe2}took '
  ...
  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%F{#b5bfe2}with '
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PREFIX='%F{#b5bfe2}at '
  ...
  typeset -g POWERLEVEL9K_TOOLBOX_PREFIX='%F{#b5bfe2}in '
  ...
  typeset -g POWERLEVEL9K_TIME_PREFIX='%F{#b5bfe2}at '
