# Config file for Powerlevel10k with the style of robbyrussell (Catppuccin Frappé) theme from Oh My Zsh.
#
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND='#a6d189'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND='#e78284'
  # Prompt symbol: bold arrow.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_CONTENT_EXPANSION='%B➜ '

  # Cyan current directory.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#85c1dc'
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=b5bfe2
